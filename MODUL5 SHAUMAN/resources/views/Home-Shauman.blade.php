    ...
    <div class="container text-center" style="padding : 100px 10%">
      <div class="row">
        ...
        <h3 id="aboutus" style=""><br><br><b>Selamat Datang Di <br> Show Room [Shauman]</b></h3>
          ...
          <li class="list-group-item"><a href="Add" class="btn btn-primary">MyCar</a></li>

      <footer>

        <div class="text-center p-3">
          <img width= "70px" height= "20px" src="http://esd.rg.telkomuniversity.ac.id/wp-content/uploads/sites/11/2017/04/logo_eadLab-300x85.jpg" >
